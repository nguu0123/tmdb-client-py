...
This test suite checks the methods of the Test class of tmdb_client_py.
...
class TVTestCase(unittest.TestCase):
    ...
    def test_tv_rating_and_rating_delete(self):
        ...
        self.assertTrue(
            tv.status_code, status_code_create or tv.status_code == status_code_update
        )
...
class TVEpisodesTestCase(unittest.TestCase):
    ...
    def test_tv_episodes_rating(self):
        ...
        self.assertTrue(
            tv_episode.status_code == status_code_create
